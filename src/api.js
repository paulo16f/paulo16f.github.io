...
export const gameDevelopersDetailsURL = (game_id) =>
  `${base_url}games/${game_id}/development-team?key=${process.env.REACT_APP_API_KEY}`; 
export const gameStoresDetailsURL = (game_id) =>
  `${base_url}games/${game_id}/stores?key=${process.env.REACT_APP_API_KEY}`; 
//Game ScreenShots
